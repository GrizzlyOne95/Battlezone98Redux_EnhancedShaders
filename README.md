...
- `GrizzlyOne95` for current shader maintenance, integration, and lighting-pass work in this fork.
- `VTrider` for the EXU-side material-scheme plumbing that this addon path builds on.
